...
require (
	...
	github.com/easynet-cn/winter v1.2.4
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.1.4 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/ess v1.1.4 // indirect
